				...
				<form action='#' className={styles.form}>
					...
					<div className={styles.row}>
						<div className={styles.column}>
							...
							<input type="text" placeholder='9876543210' value={number} onChange={e => setNumber(e.target.value)} required />
						</div>
						<div className={styles.column}>
							<label htmlFor="altNumber">Alternate Number</label>
							<input type="text" placeholder='9876543210' value={altNumber} onChange={e => setAltNumber(e.target.value)} />
						</div>
					</div>
					<div className={styles.row}>
						<div className={styles.column}>
					...
					<div className={styles.row}>
						...
						<div className={styles.column}>
							...
							<input type="password" placeholder='******' value={cnfPassword} onChange={e => setCnfPassword(e.target.value)} />
						</div>
					</div>
